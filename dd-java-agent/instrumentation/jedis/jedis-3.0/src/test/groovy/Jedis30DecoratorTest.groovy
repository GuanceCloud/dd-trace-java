...
import datadog.trace.instrumentation.jedis30.JedisClientDecorator
import redis.clients.jedis.Connection

class Jedis30DecoratorTest extends InstrumentationSpecification {

  def "configured host does not override peer hostname by default"() {
    setup:
    def span = TEST_TRACER.startSpan("test", "redis.query")
    def connection = new Connection("10.225.132.12", 6379)
...
class Jedis30DecoratorConfigHostForkedTest extends InstrumentationSpecification {
