...
public class Config {
  ...
  private final String log4j2TraceAsyncPattern;
  ...
  private Config(final ConfigProvider configProvider, final InstrumenterConfig instrumenterConfig) {
    ...
    log4j2TraceAsyncPattern =
        configProvider.getString(LOG4J2_TRACE_ASYNC_PATTERN);
  ...
  public String getLog4j2TraceAsyncPattern() {
    return log4j2TraceAsyncPattern;
  }
