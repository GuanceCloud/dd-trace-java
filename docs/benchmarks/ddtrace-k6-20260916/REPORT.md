...
下表以 300 RPS 无探针为基线，展示启用各类 ddtrace 数据后的资源和延迟增幅：

| 配置（300 RPS） | 平均延迟 | P95 | CPU/千请求 | RSS P95 |
|---|---:|---:|---:|---:|
| 无探针 | +0.0% | +0.0% | +0.0% | +0.0% |
| 仅 Trace | +3.3% | +4.7% | +6.0% | +11.7% |
| 仅 Profile | +2.2% | +1.0% | +1.0% | +15.7% |
| 仅 Metrics | +0.1% | +0.9% | +0.3% | +7.8% |
| Trace+Profile+Metrics | +8.9% | +8.5% | +8.4% | +29.5% |
